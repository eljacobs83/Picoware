...
echo "Building CircuitPython Picoware firmware for PicoCalc Pico 2..."
...
pioasm_path=""
if [ -f "/Users/user/pico/micropython/ports/rp2/build-RPI_PICO2/pioasm/pioasm" ]; then
    pioasm_path="/Users/user/pico/micropython/ports/rp2/build-RPI_PICO2/pioasm/pioasm"
